...
with open('data/raw/Kinshasa/kinshasa-schools.json', 'r') as f:
    data = json.load(f)
...
# Create the CSV file
with open('data/raw/Kinshasa/kinshasa-schools.csv', 'w', newline='') as f:
    writer = csv.writer(f)
    # Add column headers
...
print(f"Successfully converted {len(schools)} schools to data/raw/Kinshasa/kinshasa-schools.csv")
